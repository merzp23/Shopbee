...
<body>
    <div class="d-flex flex-nowrap">
        <div class="d-flex flex-column flex-shrink-0 pt-3 background-purple rounded-end" style="width: 260px;">
            <a href="/"
                class="d-flex align-items-center justify-content-center mb-3 mb-md-0 white text-decoration-none">
            ...
            <ul class="nav flex-column mb-auto">
                ...
                <li class="nav-item px-2 py-1 @if (Route::currentRouteName() === 'products') active @endif">
                    <a href="#"
                        class="nav-link white roboto-regular fs-5  d-flex align-items-center  justify-content-between"
                        aria-current="page">
                        <svg class ="me-3" xmlns="http://www.w3.org/2000/svg" width="19" height="20"
                ...
                <li class="nav-item px-2 py-1 @if (Route::currentRouteName() === 'orders') active @endif">
                    <a href="{{ route('orders') }}"
                        class="nav-link white roboto-regular fs-5  d-flex align-items-center  justify-content-between"
                        aria-current="page">
                        <svg class ="me-3" xmlns="http://www.w3.org/2000/svg" width="19" height="20"
            ...
            <div class="px-2 nav-item py-3">
                <a href="{{ route('logout') }}"
                    class="white roboto-regular fs-5  d-flex align-items-center  justify-content-start text-decoration-none"
                    aria-current="page">
                    <svg class ="ms-2 me-5" xmlns="http://www.w3.org/2000/svg" width="24" height="18"
                        viewBox="0 0 26 20" fill="none">
                        <path d="M25 10H1M1 10L10 19M1 10L10 1" stroke="white" stroke-width="2"
