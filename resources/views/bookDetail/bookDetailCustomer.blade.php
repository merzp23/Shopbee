                  ...
                  <div class = "col-6">
                    ...
                    <!-- <form id = "form">
                      <div class="form-group">
                        <textarea class="form-control mb-2" name="reviewtext" rows="4"></textarea>
                        <input type="button" class="btn" value = "Send" name = "Send" onclick = "getData()">
                      </div>
                    </form>
                    <div id="wroteComment"></div> -->
                  </div>
              </div>
